...
CREATE TABLE "parents" (
    ...
    "password_hash" TEXT,
    "thaid_sub" TEXT,
    "identity_provider" "IdentityProvider" NOT NULL DEFAULT 'LOCAL',
...
-- CreateIndex
CREATE UNIQUE INDEX "parent_student_mapping_parent_id_student_id_key" ON "parent_student_mapping"("parent_id", "student_id");
...
-- AddForeignKey
ALTER TABLE "parent_student_mapping" ADD CONSTRAINT "parent_student_mapping_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "parents"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "parent_student_mapping" ADD CONSTRAINT "parent_student_mapping_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "students"("id") ON DELETE CASCADE ON UPDATE CASCADE;
