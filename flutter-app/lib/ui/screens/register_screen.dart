        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                _field(_nameCtrl,  'Name',    Icons.person_outline_rounded,  TextInputType.name),
                ...
                const SizedBox(height: 14),
                _field(_passCtrl,  'Password (≥ 8 ตัว)', Icons.lock_outline_rounded, TextInputType.visiblePassword,
                    obscure: true),
                if (_error != null) ...[
