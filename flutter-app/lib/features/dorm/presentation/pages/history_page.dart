...
/// Auto-polls every 30 s via Timer.periodic (company pattern).
...
class _HistoryPageState extends State<HistoryPage> {
  ...
  void initState() {
    ...
    _pollTimer = Timer.periodic(
      _pollInterval,
      (_) => context.read<DormBloc>().add(const DormRefreshHistory()),
    );
  }
